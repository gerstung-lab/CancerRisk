...
# ### Outcome:
# 
# - Genealogy information written to HDF5 files - 'genealogy'
# 
# 
...
with h5py.File(d_data + 'DB/DB/raw/_' + str(var1), 'a') as f:
    for idx in ref[var1]:
        ...
        _write('mother', p, sex, birthyear, status, EOO, cancer, degree)

        # father
        p, sex, birthyear, status, EOO, cancer, degree = find_values(pid_father, degree=0.5)
        _write('father', p, sex, birthyear, status, EOO, cancer, degree)
        ...
        for sib in pid_siblings:
            ...
            _write('mother/siblings/_' + str(n), p, sex, birthyear, status, EOO, cancer, degree)
            ...
            for kid in pid_children:
                ...
                _write('mother/siblings/_' + str(n) + '/children/_' + str(nn), p, sex, birthyear, status, EOO, cancer, degree)
                nn += 1
            n += 1
        for sib in pid_half_siblings_mother:
        ...
        for sib in pid_siblings:
            p, sex, birthyear, status, EOO, cancer, degree = find_values(sib, degree=0.25)
            _write('father/siblings/_' + str(n), p, sex, birthyear, status, EOO, cancer, degree)
            f[idx]['genealogy/father/siblings/_' + str(n)].create_group('children')
            pid_children = _children(sib)
            nn = 0
            for kid in pid_children:
                p, sex, birthyear, status, EOO, cancer, degree = find_values(kid, degree=0.125)
                _write('father/siblings/_' + str(n) + '/children/_' + str(nn), p, sex, birthyear, status, EOO, cancer, degree)
                nn += 1
            n += 1
        for sib in pid_half_siblings_mother:
            p, sex, birthyear, status, EOO, cancer, degree = find_values(sib, degree=0.126)
        ...
        for sib in pid_siblings:
            ...
            _write('siblings/_' + str(n), p, sex, birthyear, status, EOO, cancer, degree)
            ...
            for kid in pid_children:
                ...
                _write('siblings/_' + str(n) + '/children/_' + str(nn), p, sex, birthyear, status, EOO, cancer, degree)
                nn += 1
            n += 1
        for sib in pid_half_siblings_mother:
